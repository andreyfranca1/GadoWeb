...
<body>
    ...
    <div class="page-wrapper">
        <div class="page-breadcrumb">
            ...
            <div class="row">
                <div class="col-3">
                    <button class="btn btn-primary mr-2" id="openModal" data-toggle="modal" data-target="#modalVacina"> Adicionar Medicamento</button>
                </div>
            </div>
        </div>
        <!-- ============================================================== -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group row">
                        <label for="select" class="col-4 col-form-label">Vacina</label> 
                        <div class="col-8">
