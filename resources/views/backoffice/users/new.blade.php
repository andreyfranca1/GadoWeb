                    ...
                    <div class="d-flex align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('backoffice.user.index')}}">Usuários</a>
                                </li>
                    ...
                    <div class="row mb-2">
                        <form action="{{route('backoffice.user.new')}}" method="post">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane show active" id="empresa" role="tabpanel"
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input id="district" name="district" type="text" required="required"
                                                       class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                <label for="passwordConfirm" id="passwordConfirmLabel">Confirmar
                                                    Senha</label>
                                                <div class="input-group">
