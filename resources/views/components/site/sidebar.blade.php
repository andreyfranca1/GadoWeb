...
{{--                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('backoffice.companies')}}" aria-expanded="false"><i class="mdi mdi-cow"></i><span class="hide-menu">Bovinos</span></a></li>--}}
                ...
                <li class="dropdown sidebar-item">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <li><a class="dropdown-item sidebar-link" href="#"><i class="mdi mdi-food"></i>Alimentos</a></li>
                        <li><a class="dropdown-item sidebar-link" href="#"><i class="fas fa-capsules"></i>Medicamentos</a></li>
                        <li><a class="dropdown-item sidebar-link" href="#"><i class="fas fa-syringe"></i>Vacinas</a></li>
                    </ul>
                </li>
                <li class="dropdown sidebar-item">
